...
public abstract class Enemy extends Entity {
    ...
    public Enemy(int x, int y, int panelWidth, int panelHeight) {
        ...
        if (walkDown == null) {
            walkUp    = loadStrip("TheLastStand/assets/enemies/walk/normal/up",    8);
            walkDown  = loadStrip("TheLastStand/assets/enemies/walk/normal/down",  8);
            walkLeft  = loadStrip("TheLastStand/assets/enemies/walk/normal/left",  8);
            walkRight = loadStrip("TheLastStand/assets/enemies/walk/normal/right", 8);

            attackUp    = loadStrip("TheLastStand/assets/enemies/attack/normal/attack_up",    6);
            attackDown  = loadStrip("TheLastStand/assets/enemies/attack/normal/attack_down",  6);
            attackLeft  = loadStrip("TheLastStand/assets/enemies/attack/normal/attack_left",  6);
            attackRight = loadStrip("TheLastStand/assets/enemies/attack/normal/attack_right", 6);
        }
