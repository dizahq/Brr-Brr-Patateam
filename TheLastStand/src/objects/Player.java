...
public class Player extends Entity {
    ...
    public Player(int x, int y, int panelWidth, int panelHeight, Game game) {
        ...
        if (walkDown == null){
            walkUp = loadStrip("TheLastStand/assets/player/normal/up",4);
            walkDown = loadStrip("TheLastStand/assets/player/normal/down",4);
            walkLeft = loadStrip("TheLastStand/assets/player/normal/left",4);
            walkRight = loadStrip("TheLastStand/assets/player/normal/right",4);
            walkUpRight = loadStrip("TheLastStand/assets/player/normal/upperdiagonal_right",4);
            walkUpLeft = loadStrip("TheLastStand/assets/player/normal/upperdiagonal_left",4);
            walkDownRight = loadStrip("TheLastStand/assets/player/normal/lowerdiagonal_right",4);
            walkDownLeft  = loadStrip("TheLastStand/assets/player/normal/lowerdiagonal_left",4);
        }
