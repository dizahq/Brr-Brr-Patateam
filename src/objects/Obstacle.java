...
public class Obstacle extends GameObject {
    ...
    public Obstacle(int x, int y, int width, int height, int panelWidth, int panelHeight, int type, boolean fullCollision) {
        ...
        obstacle1 = new ImageIcon("assets/obstacles/obs1.PNG").getImage();
        obstacle2 = new ImageIcon("assets/obstacles/obs2.PNG").getImage();
        obstacle3 = new ImageIcon("assets/obstacles/obs3.PNG").getImage();
        obstacle4 = new ImageIcon("assets/obstacles/obs4.PNG").getImage();
