    ...
    public Bullet(int x, int y, Direction direction){
        ...
        if (bulletImages == null) {
            bulletImages = new Image[]{
                new ImageIcon("assets/objects/ammo/arrow_up.png").getImage(),
                new ImageIcon("assets/objects/ammo/arrow_upRight.png").getImage(),
                new ImageIcon("assets/objects/ammo/arrow_right.png").getImage(),
                new ImageIcon("assets/objects/ammo/arrow_downRight.png").getImage(),
                new ImageIcon("assets/objects/ammo/arrow_down.png").getImage(),
                new ImageIcon("assets/objects/ammo/arrow_downLeft.png").getImage(),
                new ImageIcon("assets/objects/ammo/arrow_left.png").getImage(),
                new ImageIcon("assets/objects/ammo/arrow_upLeft.png").getImage()
            };
        }
