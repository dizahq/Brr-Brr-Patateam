...
public class Game extends JPanel {
    ...
    public Game(int panelWidth, int panelHeight, MainLayeredPane rootLayeredPane) {
        ...
        grassImage = new ImageIcon("assets/background/Grass BG.png").getImage();          //REPLACED
        grassOverlay = new ImageIcon("assets/background/BG Overlay.png").getImage();      //NEW
        lifeFullImage = new ImageIcon("assets/interface/life_Full.png").getImage();
        lifeEmptyImage = new ImageIcon("assets/interface/life_Empty.png").getImage();
        for (int i = 0; i < 5; i++) {
            waveImages[i] = new ImageIcon("assets/interface/wave/wave" + (i + 1) + ".png").getImage();
        }
